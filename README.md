...
| 舒欣  |  vickyshuaaa@gmail.com   |  x1shu@ucsd.edu  |                                                            负责了PC端页眉板块(`the-header.vue`)的`HTML`与样式代码。                                                            |
| 陈嵲淏 |  leochen5206@icloud.com  | nichen@ucsd.edu  |                                                         负责了PC端主页头图板块(`home-headline.vue`)的`HTML`与样式代码。                                                          |
| 陈子轩 |                          | Zic022@ucsd.edu  |                                                         负责了PC端主页头图板块(`home-headline.vue`)的`HTML`与样式代码。                                                          |
| 蒋澜  |                          | l3jiang@ucsd.edu |                                                          负责了PC端主页社团介绍板块(`home-intro.vue`)的`HTML`与样式代码。                                                          |
| 鈕臻真 |                          |  cniu@ucsd.edu   |                                                          负责了PC端主页社团介绍板块(`home-intro.vue`)的`HTML`与样式代码。                                                          |
| 李昱增 |  ellison0930@gmail.com   | yul054@ucsd.edu  |                                             负责了PC端主页文章板块(`home-articles.vue`与`home-article-tab.vue`)部分的`HTML`与样式代码。                                             |
| 吴不为 |                          |  buwu@ucsd.edu   |                                             负责了PC端主页文章板块(`home-articles.vue`与`home-article-tab.vue`)部分的`HTML`与样式代码。                                             |
| 谷悦萌 |                          | yug027@ucsd.edu  |                                                            负责了PC端主页问答板块(`home-faq.vue`)的`HTML`与样式代码。                                                            |
| 舒畅  |   changs0604@gmail.com   |  c1shu@ucsd.edu  |                                                            负责了PC端页尾板块(`the-footer.vue`)的`HTML`与样式代码。                                                            |
| 曾亦嘉 |                          | y2zeng@ucsd.edu  |                                                            负责了PC端页尾板块(`the-footer.vue`)的`HTML`与样式代码。                                                            |
| 陈佳钰 | smallshrimp233@gmail.com | jic034@ucsd.edu  |        负责了PC端部门页面的面包屑导航板块(`department-breadcrumb.vue`)、部门介绍板块(`department-intro.vue`)和部门成员板块(`department-members.vue`与`department-tab.vue`)的`HTML`与样式代码。        |
| 王晓玥 |  moanawangdp@gmail.com   | xiw027@ucsd.edu  |        负责了PC端部门页面的面包屑导航板块(`department-breadcrumb.vue`)、部门介绍板块(`department-intro.vue`)和部门成员板块(`department-members.vue`与`department-tab.vue`)的`HTML`与样式代码。        |
