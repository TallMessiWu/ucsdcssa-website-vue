...
| 陈佳钰 |                        | jic034@ucsd.edu  |        负责了PC端部门页面的面包屑导航板块(`department-breadcrumb.vue`)、部门介绍板块(`department-intro.vue`)和部门成员板块(`department-members.vue`与`department-tab.vue`)的`HTML`与样式代码。        |
| 王晓玥 | moanawangdp@gmail.com  | xiw027@ucsd.edu  |                                   负责了PC端部门页面的面包屑导航板块(`department-breadcrumb.vue`)和部门介绍板块(`department-intro.vue`)的`HTML`与样式代码。                                   |
